param(
  [string]$Out = 'H:\\comsolcc\\comsol_magnet\\work\\modelB_x26_transition_sparse_20260912'
)
...
$argLine = '-Xmx12g -cp "H:\\comsolcc\\comsol_magnet\\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" transition' -f $Plugins,$Source,$Out
...
Write-Output ("PID={0} OUT={1} Z=105,110,115 PHI=0:45:360" -f $proc.Id,$Out)
