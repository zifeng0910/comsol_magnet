param([string]$Out = 'H:\comsolcc\comsol_magnet\work\modelB_alpha0_z100_120_full360_20260913')
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" alpha0full360' -f $Plugins,$Source,$Out
...
Write-Output ("PID={0} OUT={1} ALPHA=0 Z=100:2.5:120 PHI=0:10:360" -f $proc.Id,$Out)
