...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_z110_140_phi90_fine_20260911'
...
$argLine = '-cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBSameMeshDifferential "{1}" "{2}" PHI90_ONLY 110 112.5 115 117.5 120 122.5 125 127.5 130 132.5 135 137.5 140' -f $Plugins,$Source,$Out
