param(
  [string]$Out = 'H:\\comsolcc\\comsol_magnet\\work\\modelB_x26_macro_phi_sparse_20260912'
)
...
$argLine = '-Xmx12g -cp "H:\\comsolcc\\comsol_magnet\\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" macrosparse' -f $Plugins,$Source,$Out
...
Write-Output ("PID={0} OUT={1} Z=60,80,100,120,140,160" -f $proc.Id,$Out)
