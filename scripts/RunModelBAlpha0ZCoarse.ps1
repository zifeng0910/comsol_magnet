...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_alpha0_z_coarse_scan_20260911'
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" zalpha0' -f $Plugins,$Source,$Out
