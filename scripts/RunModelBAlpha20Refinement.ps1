param(
  [string]$Out = 'H:\comsolcc\comsol_magnet\work\modelB_alpha20_z70_90_refinement_20260912'
)
...
$argLine = '-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" alpha20refine' -f $Plugins,$Source,$Out
...
Write-Output ("PID={0} OUT={1} ALPHA=20 Z=70,75,85,90 PHI=0:45:360" -f $proc.Id,$Out)
