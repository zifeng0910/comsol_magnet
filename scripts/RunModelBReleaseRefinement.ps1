...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_alpha0_release_refinement_20260911'
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" release' -f $Plugins,$Source,$Out
