...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_z120_phi90_alpha_coarse_20260911'
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" alpha' -f $Plugins,$Source,$Out
