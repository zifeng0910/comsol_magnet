param(
  [string]$Out = 'H:\\comsolcc\\comsol_magnet\\work\\modelB_alpha20_sparse_20260912'
)
...
$argLine = '-Xmx12g -cp "H:\\comsolcc\\comsol_magnet\\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" alpha20sparse' -f $Plugins,$Source,$Out
