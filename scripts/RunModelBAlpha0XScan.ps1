...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_alpha0_x60_scan_20260912'
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" xscan' -f $Plugins,$Source,$Out
