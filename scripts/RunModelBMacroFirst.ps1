param(
  [string]$Out = 'H:\\comsolcc\\comsol_magnet\\work\\modelB_x26_macro_z_phi90_first_20260912'
)
...
$argLine = '-Xmx12g -cp "H:\\comsolcc\\comsol_magnet\\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" macrofirst' -f $Plugins,$Source,$Out
...
Write-Output ("PID={0} OUT={1} FIRST_Z=120,140,150" -f $proc.Id,$Out)
