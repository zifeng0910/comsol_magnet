...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_alpha0_z60_M02_validation_20260911'
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" candidateM02' -f $Plugins,$Source,$Out
