...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_z50_stageA_20260912'
...
$argLine='-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}" sparse50' -f $Plugins,$Source,$Out
