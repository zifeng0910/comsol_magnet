...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_local_optimum_h002_retry_20260911'
...
$argLine = '-cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBSameMeshDifferential "{1}" "{2}" H002_ONLY 120' -f $Plugins,$Source,$Out
