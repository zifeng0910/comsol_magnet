...
$Out = 'H:\comsolcc\comsol_magnet\work\modelB_z120_local_mesh_convergence_20260911_v4'
...
$argLine = '-Xmx12g -cp "H:\comsolcc\comsol_magnet\scripts;{0}" RunModelBLocalMeshConvergence "{1}" "{2}"' -f $Plugins,$Source,$Out
